...
namespace SelectLTHashHashGT
{
    ...
    internal sealed class ReverseSelectRegion : SelectorReverse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReverseSelectRegion"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private ReverseSelectRegion(AsyncPackage package, OleMenuCommandService commandService) : base(package, SelectRegion.StartRegion(), SelectRegion.EndRegion())
        {
        ...
        /// </summary>
        public static ReverseSelectRegion Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new ReverseSelectRegion(package, commandService);
        }
